...
import { getMetricasDashboard, getTopClientes } from "@/lib/services/metricas";
...
export default async function DashboardPage() {
  ...
  const [data, topClientes] = await Promise.all([getMetricasDashboard(), getTopClientes()]);

  return <DashboardView data={data} topClientes={topClientes} />;
}
