...
import { ViewEditarServicio } from "./view-editarServicio";

export const dynamic = "force-dynamic";

export const metadata: Metadata = { title: "Editar servicio | Geek Design" };
...
export default async function EditarServicioPage({ params }: Props) {
  ...
  return <ViewEditarServicio servicio={servicio} />;
}
