  ...
  if (!isAuthorized || !quote) {
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="max-w-[500px] w-full bg-white rounded-[24px] border border-line-soft p-10 text-center shadow-[0_12px_40px_rgba(0,0,0,0.04)]">
          <div className="w-20 h-20 rounded-full bg-wine-soft flex items-center justify-center text-wine mx-auto mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-3 h-[64px] px-8 bg-wine text-white rounded-[12px] font-bold text-[16px] hover:bg-wine-hover transition-all shadow-lg shadow-wine/20"
          >
