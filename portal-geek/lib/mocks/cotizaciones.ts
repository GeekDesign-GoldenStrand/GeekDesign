...
export const MOCK_SCENARIOS: Record<string, Scenario> = {
  "203": {
    ...
    servicios: [
      {
        id: 1,
        nombre: "Playeras Polo",
        descripcion: "Lote 50 Piezas",
        estado: "sin_cambios",
        precio_anterior: 8500,
        precio_nuevo: 8500,
        motivo: null,
        detalles_cliente: "Tallas M y L.",
      },
      {
        id: 2,
        nombre: "Vinil Fachada",
        descripcion: "Instalación",
        estado: "modificado",
        precio_anterior: 4200,
        precio_nuevo: 5800,
        cambio: "+38%",
        motivo: "Ajuste de metraje.",
        detalles_cliente: "Ventana principal.",
      },
      {
        id: 4,
        nombre: "Stand Expo",
        descripcion: "Renta Truss",
        estado: "rechazado",
        precio_anterior: 15000,
        precio_nuevo: null,
        motivo: "Sin stock.",
        detalles_cliente: "Expo Industriales.",
      },
    ],
    ...
    servicios: [
      {
        ...
        precio_nuevo: 1200,
        motivo: null,
        detalles_cliente: "Papel couché 350g.",
      },
      {
        id: 2,
        nombre: "Diseño de Logotipo",
        descripcion: "Propuesta 3 conceptos",
        estado: "sin_cambios",
        precio_anterior: 3500,
        precio_nuevo: 3500,
        motivo: null,
        detalles_cliente: "Estilo moderno.",
      },
    ],
  ...
  modificada: {
    ...
    servicios: [
      {
        id: 1,
        nombre: "Letrero Luminoso LED",
        descripcion: "1.5m x 0.5m",
        estado: "modificado",
        precio_anterior: 7000,
        precio_nuevo: 8500,
        cambio: "+21%",
        motivo: "Incremento en costo de acrílico.",
        detalles_cliente: "Iluminación blanca.",
      },
      {
        id: 2,
        nombre: "Instalación Eléctrica",
        descripcion: "Punto de conexión",
        estado: "modificado",
        precio_anterior: 1500,
        precio_nuevo: 2200,
        cambio: "+46%",
        motivo: "Requiere cableado de mayor calibre.",
        detalles_cliente: "Caja de fusibles a letrero.",
      },
    ],
  ...
  rechazada: {
    ...
    servicios: [
      {
        id: 1,
        nombre: "Estructura para Eventos",
        descripcion: "Escenario móvil",
        estado: "rechazado",
        precio_anterior: 25000,
        precio_nuevo: null,
        motivo: "Mantenimiento preventivo en esas fechas.",
        detalles_cliente: "Evento al aire libre.",
      },
    ],
    ...
    servicios: [
      {
        ...
        descripcion: "Lote 100 Piezas",
        estado: "sin_cambios",
        precio_anterior: 4500,
        precio_nuevo: 4500,
        motivo: null,
        detalles_cliente: "Logo a dos tintas.",
      },
    ],
