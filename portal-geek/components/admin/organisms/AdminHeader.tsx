...
export function AdminHeader({ title }: AdminHeaderProps) {
  return (
    <header className="sticky top-0 z-20 flex h-[80px] md:h-[118px] w-full items-center justify-between bg-white px-6 md:px-8 shadow-[0_4px_7px_rgba(0,0,0,0.05)] border-b border-[#F5F5F5]">
