...
export function ConfirmarEliminarServicioModal({
  ...
  return (
    <ModalShell title="Eliminar servicio" onClose={onClose}>
      <div className="flex flex-col gap-4">
        <p className="text-[14px] text-[#575757]">
          ¿Está seguro de que desea eliminar el servicio{" "}
          <span className="font-medium text-[#1e1e1e]">{servicioName}</span>? Su estatus cambiará a{" "}
          <span className="font-medium">Inactivo</span> y dejará de aparecer en el listado.
        </p>
