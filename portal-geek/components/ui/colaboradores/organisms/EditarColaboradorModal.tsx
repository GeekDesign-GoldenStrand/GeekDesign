...
function validate(form: FormState): Record<string, string> {
  ...
  else if (!NOMBRE_REGEX.test(form.nombre_completo)) errors.nombre_completo = "Solo letras, espacios, guiones y apóstrofes.";
  if (!form.correo_electronico.trim()) errors.correo_electronico = "El correo es requerido.";
  else if (!EMAIL_REGEX.test(form.correo_electronico)) errors.correo_electronico = "Correo electrónico inválido.";
  const edad = Number(form.edad);
  if (!form.edad) errors.edad = "La edad es requerida.";
  else if (isNaN(edad) || edad < 16 || edad > 100) errors.edad = "La edad debe ser entre 15 y 100 años.";
        ...
        <div className="p-6 overflow-y-auto">
          ...
          {!loadingData && !fetchError && apiRow && (
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
              ...
              <div>
                <label className={LABEL}>Nombre <span className="text-[#e42200]">*</span></label>
                <input
                  type="text"
                  maxLength={100}
                  placeholder="Nombre completo"
                  value={form.nombre_completo}
                  onChange={(e) => setField("nombre_completo", e.target.value.replace(/[^a-zA-ZÀ-ÿ\s'\-]/g, ""))}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className={LABEL}>Correo <span className="text-[#e42200]">*</span></label>
                  <input
                    type="email"
                    maxLength={150}
                ...
                <div>
                  <label className={LABEL}>Teléfono <span className="text-[#e42200]">*</span></label>
                  <input
                    type="tel"
                    inputMode="numeric"
                    maxLength={10}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className={LABEL}>Edad <span className="text-[#e42200]">*</span></label>
                  <input
                    type="text"
                    inputMode="numeric"
                    maxLength={2}
                ...
                <div>
                  <label className={LABEL}>Sexo <span className="text-[#e42200]">*</span></label>
                  <select
                    value={form.sexo}
              ...
              <div>
                <label className={LABEL}>Rol <span className="text-[#e42200]">*</span></label>
                <select
                  value={form.id_rol}
              ...
              <div>
                <label className={LABEL}>Sucursal <span className="text-[#e42200]">*</span></label>
                <select
