  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-[20px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] w-full max-w-[500px] flex flex-col max-h-[85vh] overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-[rgba(255,117,24,0.02)]">
          <div>
            <h2 className="text-xl font-bold text-[#1e1e1e]">Asignar Servicios</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-12 gap-3">
              <div className="w-8 h-8 border-4 border-[#FF7518] border-t-transparent rounded-full animate-spin" />
        ...
        <div className="p-6 border-t border-gray-100 flex justify-end gap-3 bg-gray-50/50">
          ...
          <button
            ...
            className="px-8 py-2.5 text-[14px] font-bold text-white bg-[#FF7518] hover:bg-[#e66a15] rounded-[10px] transition-all shadow-[0_4px_15px_rgba(255,117,24,0.3)] hover:shadow-[0_6px_20px_rgba(255,117,24,0.4)] active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
          >
