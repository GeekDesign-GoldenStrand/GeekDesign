              ...
              return (
                <tr key={item.id_detalle} className="border-b border-gray-100 last:border-0">
                  <td className="py-3 px-2">
                    ...
                    {item.color && <p className="text-[13px] text-gray-600">Color: {item.color}</p>}
                    {item.notas && <p className="text-[13px] text-gray-600 italic">{item.notas}</p>}
                  </td>
                  ...
                  <td className="py-3 px-2 text-gray-700 whitespace-nowrap">{dims || "—"}</td>
